...
public abstract class BaseCommand implements CommandExecutor {
     ...
     */
    public final static String PERMISSION_BASE = "hatena.biomeanalyser";
     ...
     * @return
     */
    protected boolean isPlayerSource(CommandSource src) {
    ...
    public void registerSelf() {
        Sponge.getCommandManager().register(BiomeAnalyser.getInstance(), buildSelf(), alias);
    }
}
